        ...
        <div class="them-nd">
          ...
          <form method="post" action="">
            <div class="form-group">
              ...
              <input class="form-control" id="MA_NHOM" name="MA_NHOM" aria-describedby="emailHelp" placeholder="" />
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">Tên nhóm người dùng</label>
              <input class="form-control" id="TEN_NHOM" name="TEN_NHOM" aria-describedby="emailHelp" placeholder="" />
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">Ghi chú</label>
              <textarea class="form-control" id="GHI_CHU" name="GHI_CHU" aria-describedby="emailHelp" placeholder=""></textarea>
            </div>
          </form>
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    ...
    $("#SAVE").click(function() {
      var gROUP_INFO = [$("#MA_NHOM").val(), $("#TEN_NHOM").val(), $("#GHI_CHU").val()];

      $.ajax({
        type: "POST",
        url: "http://localhost/phan_quyen_chi_phi/modules/user_groups/insert_group.php",
        data: {
          gROUP_INFO
        },
    ...
    $("#EDIT").click(function() {
      ...
      $.ajax({
        type: "POST",
        url: "http://localhost/phan_quyen_chi_phi/modules/user_groups/edit_group.php",
        data: {
          gROUP_INFO
        },
        success: function(result) {
