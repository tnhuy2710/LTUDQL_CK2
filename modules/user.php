  ...
  jQuery(document).ready(function() {
    ...
    //Lấy người dùng theo đơn vị
     $("#s_DON_VI").change(function(){
      var DON_VI = $(this).val();
      var s_DON_VI = "s_DON_VI="+DON_VI;

      $.ajax({
        type: "POST",
        url: "http://localhost/test11/modules/user/get_user_by_DV.php",
        data: s_DON_VI,
        success: function(result){
          $("#show").html(result);
        }
      ...
      $("#SAVE").click(function(){
        ...
        else
        {
          ...
          $.ajax({
            type: "POST",
            url: "http://localhost/test11/modules/user/insert_user.php",
            data: {uSER_INFO, new_GROUPS},
            success: function(result){
      ...
      $("#DELETE").click(function(){
        ...
        $.ajax({
          type: "POST",
          url: "http://localhost/test11/modules/user/delete_user.php",
          data: uSER_INFO,
          success: function(result){
            console.log(result);
            $('#attention').html(result);
      ...
      $("#EDIT").click(function(){
        ...
        $.ajax({
          type: "POST",
          url: "http://localhost/test11/modules/user/edit_user_groups.php",
          data: {mA_ND, insert_GROUPS, delete_GROUPS},
          success: function(result){
            $('#attention').html(result);
            $('#attentionModal').modal('show');            
          }
